...
model = Sequential()                
model.add(GRU(units=38 ,input_shape =(3,1)))  
...
# ________if units=10_GRU 계산법 10*3*(10 + 1 + 1)__________________
# Layer (type)                 Output Shape              Param #       
# =================================================================     
# gru (GRU)                    (None, 38)                4560
# _________________________________________________________________     
# dense (Dense)                (None, 25)                975
# _________________________________________________________________     
# dense_1 (Dense)              (None, 45)                1170
# _________________________________________________________________     
...
#RNN *연산법 units =10) * (feature + bisa + units) = parms 
#LSTM 숫자 4의 의미는 * (cell_state + input_gate + output_gate + forget_gate
#LSTM 연산법 units =10) 4 * 10 * (1 + 1 + 10) = 480 ////// 예) 4 * 20 * (1 + 1 + 20) = 1700
#GRU 연산법 units hidden + reset_gate + update_gate + bias
#GRU 연산법 예) units=10) 3 * 10 (1 + 1 + 10 )
