...
#     'D:/study_data/_data/image/cat_dog/train_set/train_set',
#     target_size=(150,150),
#     batch_size=500,
#     class_mode='binary',
...
x_train = np.load('d:/study_data/_save/_npy/cat_dog_1_train_x.npy')
y_train = np.load('d:/study_data/_save/_npy/cat_dog_1_train_y.npy')
x_test = np.load ('d:/study_data/_save/_npy/cat_dog_1_test_x.npy')
y_test = np.load ('d:/study_data/_save/_npy/cat_dog_1_test_y.npy') 
...
hist = model.fit(x_train,y_train ,epochs=2 , validation_split=0.25)
