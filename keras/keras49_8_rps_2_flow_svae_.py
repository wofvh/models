...
print(x_test.shape,y_test) #(309, 100, 100, 3) (309, 2)
y_train = np.argmax(y_train, axis=1)
y_test = np.argmax(y_test, axis=1)

#2. 모델
model = Sequential()
model.add(Conv2D(15,(2,2), input_shape=(100,100,3), activation='relu'))
...
# loss:  [0.04784493148326874, 0.9854497313499451]
# acc스코어 :  0.9993942975997925
# time : 31.37439513206482