...
x_train = np.load('d:/study_data/_save/_npy/rps_4_train_x.npy' )
x_test = np.load('d:/study_data/_save/_npy/rps_4_test_x.npy')
y_train = np.load('d:/study_data/_save/_npy/rps_4_train_y.npy')
y_test = np.load('d:/study_data/_save/_npy/rps_4_test_y.npy')
