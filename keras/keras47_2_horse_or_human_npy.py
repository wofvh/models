...
x_train = np.load('d:/study_data/_save/_npy/horse-or-human_2_train_x.npy')
y_train = np.load('d:/study_data/_save/_npy/horse-or-human_2_train_y.npy')
x_test = np.load('d:/study_data/_save/_npy/horse-or-human_2_test_x.npy')
y_test = np.load('d:/study_data/_save/_npy/horse-or-human_2_test_y.npy')
...
hist = model.fit(x_train,y_train ,epochs=52,batch_size=100,
