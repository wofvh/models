...
print(x_train.shape)   #(1890, 200, 200, 3)
print(x_test.shape)    #(630, 200, 200, 3)
print(y_train.shape)   #(1890,)
print(y_test.shape)    #(630,)
...
np.save('d:/study_data/_save/_npy/rps_4_train_x.npy',arr=x_train )
np.save('d:/study_data/_save/_npy/rps_4_test_x.npy',arr=x_test)
np.save('d:/study_data/_save/_npy/rps_4_train_y.npy',arr=y_train)
np.save('d:/study_data/_save/_npy/rps_4_test_y.npy',arr=y_test)
