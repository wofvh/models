...
all_input_list = sorted(glob.glob('D:/study_data/dacon/train_input/*.csv'))
all_target_list = sorted(glob.glob('D:/study_data/dacon/train_target/*.csv'))
...
# RuntimeError : freeze_support 사용
...
test_input_list = sorted(glob.glob('D:/study_data/dacon/test_input/*.csv'))
test_target_list = sorted(glob.glob('D:/study_data/dacon/test_target/*.csv'))
...
import zipfile
os.chdir("D:/study_data/dacon/test_target/")
submission = zipfile.ZipFile("D:/study_data/dacon/submission_1.zip", 'w')
