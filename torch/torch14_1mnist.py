...
train_dataset = MNIST(path, train=True, download=True,transform=transf)  #train=True 학습용 데이터 #download=True 데이터를 다운로드 받겠다
test_dataset = MNIST(path, train=False, download=True,transform=transf)  #train=False 테스트용 데이터 
