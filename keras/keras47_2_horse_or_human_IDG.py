...
np.save('d:/study_data/_save/_npy/horse-or-human_2_test_x.npy',arr=x_test)
np.save('d:/study_data/_save/_npy/horse-or-human_2_test_y.npy',arr=y_test)
...
hist = model.fit(x_train,y_train ,epochs=22,batch_size=100,
