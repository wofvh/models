...
xg = XGBClassifier()
lg = LGBMClassifier()
cat = CatBoostClassifier(verbose=False) #(verbose=False)#catboost vervose가 많음 ! 그래서 다른모델이랑 성능비교 시에는 주석처리
...
# 0.9833333333333333
# CatBoostClassifier정확도 : 0.9917
# XGBClassifier정확도 : 0.9750
# LGBMClassifier정확도 : 0.9778
# 보팅결과 :  0.9833
