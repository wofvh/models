...
dense13 = Dense(17, activation= 'relu', name ='ys12')(dense12)
dense14 = Dropout(0.2)(dense13)
dense15 = Dense(19, activation= 'relu', name ='ys13')(dense14)
dense16 = Dropout(0.2)(dense15)
dense17 = Dense(17, activation= 'relu', name ='ys14')(dense16)
...
merge3 = Dense(19, activation= 'relu',name ='mg2')(merge2)
merge4 = Dropout(0.3)(merge3)
merge5 = Dense(19, name ='mg3')(merge4)
merge6 = Dropout(0.2)(merge5)
merge7 = Dense(19, name ='mg4')(merge6)
merge8 = Dropout(0.2)(merge7)
merge9 = Dense(21, name ='mg5')(merge8)
...
# model.save_weights("./_test/keras46_1_save_weights종가10.h5")
model.load_weights("./_test/keras46_1_save_weights종가10.h5")
